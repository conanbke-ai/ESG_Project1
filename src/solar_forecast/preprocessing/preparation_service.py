"""원본 보존부터 Gold·품질 감사까지의 canonical plant-data preprocessing orchestration."""
from __future__ import annotations

from solar_forecast.infrastructure.project_paths import COLLECTOR_SILVER_ROOT

from dataclasses import dataclass
from pathlib import Path

from solar_forecast.datasets.collector_admission import (
    CollectedGenerationAdmissionResult,
    CollectedGenerationAdmissionService,
)
from solar_forecast.datasets.archive_standardizer import (
    HistoricalGenerationStandardizationService,
    StandardizationRun,
)
from solar_forecast.datasets.krc_candidate_intake import (
...
from solar_forecast.datasets.model_dataset_builder import (
    ModelDatasetResult,
