...
from solar_forecast.datasets.numeric_preprocessor import NumericPreprocessor
from solar_forecast.pipeline.html_report_adapter import HtmlReportWriter
from solar_forecast.pipeline.cnn_training_adapter import CnnTrainingAdapter
from solar_forecast.pipeline.contracts import (
    DatasetPort,
    PreprocessorPort,
    ReportPort,
    TrainingPort,
