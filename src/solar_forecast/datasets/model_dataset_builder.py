...
from solar_forecast.jobs.contracts import JOB_CONTRACT_SCHEMA_VERSION, MODEL_READY_MANIFEST_CONTRACT
from solar_forecast.quality.generation_quality import GenerationQualityPolicy, QUALITY_COLUMNS
...
from solar_forecast.datasets.plant_registry import (
    KmaStationCatalog,
