...
2026-09-07 실행에서 KOSPO 부산철도태양광2호기 파일 7,560행은
`발전소명=신재생사업본부`처럼 포괄 명칭으로 들어와 0행 retained였습니다.
후속 식별자 보강은 공식 발전기명과 사양표를 대조해 `부산철도 2`로 연결합니다.
그러나 부산진구의 설비 주소와 중구의 ASOS 159는 자동 행정구역 매칭 대상이 아니며,
공식 좌표 또는 별도 검토 기상 매핑이 필요합니다. 아래 Gold 집계는 기존 실행의 검증 결과이며
이번 변경으로 재산출한 숫자가 아닙니다. 상세는 [KOSPO 식별자 감사](KOSPO_IDENTITY_AUDIT.md)를 따릅니다.
