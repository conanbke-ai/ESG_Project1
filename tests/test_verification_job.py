...
from solar_forecast.jobs.verification_job import PipelineVerificationService
from solar_forecast.jobs.verification_job import VerificationConfig
...
def test_verification_service_writes_auditable_report(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "solar_forecast.jobs.verification_job.DataPreparationService",
        FakePreparationService,
    )
    monkeypatch.setattr(
        "solar_forecast.jobs.verification_job.TrainingService",
        FakeTrainingService,
    )
    monkeypatch.setattr(
        "solar_forecast.jobs.verification_job.DashboardBuilder",
        FakeDashboardBuilder,
    )
    monkeypatch.setattr(
        "solar_forecast.jobs.verification_job.load_model_config",
